...
const ZView_1 = __importDefault(__webpack_require__(928));
const Extension_1 = __importDefault(__webpack_require__(732));
const Webview_1 = __importDefault(__webpack_require__(602));
const RecapStyle_1 = __importDefault(__webpack_require__(866));
const RecapWebRoot_1 = __importDefault(__webpack_require__(935));
try {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const LinkTarget_1 = __importDefault(__webpack_require__(361));
class Extension {
    static isWebContext() {
    ...
    static exportSourceFiles(fileList, exportPath, srcRoot) {
...
const z_1 = __importDefault(__webpack_require__(813));
const ZInterval_1 = __importDefault(__webpack_require__(961));
class LinkTarget {
    ...
    // if there is a matching entry in the markdownLinkTargets for the current note,
    // add the text and offset
    addMarkdownTarget() {
        // TODO
        // const match = webview.currentNoteView.note.markdownLinkTargets.find((t) => t.matches(this));
        // if (match) {
        //   this.targetText = match.targetText;
        //   this.targetOffset = match.targetOffset;
        // }
    }
    asString() {
        if (!this.isValid()) {
    ...
    matches(linkTarget) {
        return (this.file === linkTarget.file && this.selections.toString() === linkTarget.selections.toString());
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const z_1 = __importDefault(__webpack_require__(813));
const RecapNote_1 = __importDefault(__webpack_require__(851));
class RecapDocument {
    constructor(text) {
        this.annotations = [];
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const RecapToolbar_1 = __importDefault(__webpack_require__(382));
class EditToolbar extends RecapToolbar_1.default {
    ...
    //name, codion, hovertext, clickAction, style
    render() {
        this
...
class LinkTargetView extends ZView_1.default {
    ...
    selectTargetRanges(linkTarget) {
        ...
        // multiple ranges only appears to be supported on Firefox
...
const ZInterval_1 = __importDefault(__webpack_require__(961));
const z_1 = __importDefault(__webpack_require__(813));
const MarkdownConverter_1 = __importDefault(__webpack_require__(363));
const RecapNote_1 = __importDefault(__webpack_require__(851));
...
const NoteText_1 = __importDefault(__webpack_require__(22));
const EditToolbar_1 = __importDefault(__webpack_require__(892));
const LinkTarget_1 = __importDefault(__webpack_require__(361));
const Extension_1 = __importDefault(__webpack_require__(732));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const ZView_1 = __importDefault(__webpack_require__(928));
const ZLabel_1 = __importDefault(__webpack_require__(974));
const z_1 = __importDefault(__webpack_require__(813));
const NoteView_1 = __importDefault(__webpack_require__(508));
const MainToolbar_1 = __importDefault(__webpack_require__(512));
const LinkTarget_1 = __webpack_require__(361);
const NotesContainerExtension_1 = __importDefault(__webpack_require__(779));
const Extension_1 = __importDefault(__webpack_require__(732));
const RecapToolbar_1 = __importDefault(__webpack_require__(382));
class NotesContainer extends ZView_1.default {
    constructor(name, params) {
        super(name, params);
        this.annotationsProp = null;
        this.params = params;
        this.style = this.createProp(this.currentStyle);
        ...
        this.mostRecentSelectionProp = this.createProp(LinkTarget_1.LinkTarget.emptyLinkTarget);
    ...
    initializeExtensionParams() {
        return {
            ...
            exportWebBundleToFolderAction: this.createAction(this.exportWebBundleToFolder),
    ...
    render() {
        ...
        if (!this.annotationsProp) {
            this.annotationsProp = this.createProp(doc.annotations);
        }
        this.annotationsProp.get().forEach((note, index) => {
    ...
    exportWebBundle() {
        Extension_1.default.getOutputDirectory();
    }
    exportWebBundleToFolder(path) {
        Extension_1.default.exportSourceFiles(this.document().allLinkTargetFileNames(), path, this.rootPath());
    }
    viewHelp() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const ZStyle_1 = __importDefault(__webpack_require__(738));
const Extension_1 = __importDefault(__webpack_require__(732));
class RecapStyle {
    static initialize() {
    ...
    static initializeRecapStyles() {
        const allStyles = {
            ...
            "recap-text-editable": "cursor-auto ml2 pre ws-pre-wrap w100 outline-0 focus-none",
            ...
            //"recap-note-selected-linked": "{recap-note-base} ba br3 bw1 o-100",
    ...
    static initializeAtomicClasses() {
        const defaults = Extension_1.default.isWebContext() && Extension_1.default.inDarkMode() ? this.darkThemeDefaults : this.lightThemeDefaults;
        const atomicClasses = {
            ".font-family-vse": `font-family:var(--vscode-editor-font-family, ${defaults.fontFamily})`,
            ".font-size-vse": `font-size:var(--vscode-editor-font-size, ${defaults.fontSize})`,
            ".color-vsf": `color:var(--vscode-foreground, ${defaults.foregroundColor})`,
            ".color-selection": `color:var(--vscode-editorLink-activeForeground, ${defaults.selectionColor})`,
            ".b--selection": `border-color:var(--vscode-editor-foreground, ${defaults.borderColor})`,
            ".bg-vse": `background-color:var(--vscode-editor-background, ${defaults.backgroundColor})`,
            ".bg-color-button": `background-color:var(--vscode-editorWidget-background, ${defaults.buttonBackgroundColor})`,
...
const ZView_1 = __importDefault(__webpack_require__(928));
const ZLabel_1 = __importDefault(__webpack_require__(974));
const RecapButton_1 = __importDefault(__webpack_require__(697));
...
const ZView_1 = __importDefault(__webpack_require__(928));
const Webview_1 = __importDefault(__webpack_require__(602));
const LinkTargetView_1 = __importDefault(__webpack_require__(817));
const Extension_1 = __importDefault(__webpack_require__(732));
const MarkdownConverter_1 = __importDefault(__webpack_require__(363));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const ZView_1 = __importDefault(__webpack_require__(928));
const NotesContainer_1 = __importDefault(__webpack_require__(412));
const RecapDocument_1 = __importDefault(__webpack_require__(694));
const RootExtension_1 = __importDefault(__webpack_require__(896));
const MarkdownConverter_1 = __importDefault(__webpack_require__(363));
class Webview extends ZView_1.default {
    ...
    loadRecapDocument(text) {
        this.documentProp.set(new RecapDocument_1.default(text));
    }
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const ZProp_1 = __importDefault(__webpack_require__(904));
const z_1 = __importDefault(__webpack_require__(813));
class ZAction {
...
class ZProp {
    ...
    release() {
        this.actions.forEach((a) => a.release());
        this.actions = new Set();
    }
    value() {
        return this.val;
    ...
    // toString() {
    //   return this.val ? this.val.toString() : "";
    // }
    performActions() {
        if (!this.actions) {
...
const ZStyle_1 = __importDefault(__webpack_require__(738));
const ZAction_1 = __importDefault(__webpack_require__(407));
const ZProp_1 = __importDefault(__webpack_require__(904));
const ZInterval_1 = __importDefault(__webpack_require__(961));
const z_1 = __importDefault(__webpack_require__(813));
/*
...
class ZView {
    constructor(name, params = {}, tagName = "div") {
        ...
        //this.setInitialStyle(initialStyle);
        this.style = params?.style || "";
     ...
     * Styles
     */
    // setInitialStyle(val: ZStyle) {
    //   if (val) {
    //     this.style = val;
    //     this.setCSSClass(z.valueof(this.style));
    //   }
    // }
    applyStyle() {
        if (this.style) {
    ...
    /*
     * Methods on plain text elements containing only <br> and text elements.
     */
    lengthOfNode(node) {
    ...
    insertText(text, position) {
        ...
        // TODO
        //textNode.style = "white-space:pre";
